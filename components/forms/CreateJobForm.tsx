...
export default function CreateJobForm({companyAbout, companyLogo, companyName, companyXAccount, companylocation, companywebsite}: iAppProps) {
    const form = useForm({
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem key={country.code} value={country.name}>
                                                    <span className="pl-5">{country.flagEmoji}</span>
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <div>
                                   ...
                                   ut-label:text-muted-foreground  ut-allowed-content:text-muted-foreground border-primary'
                                        />
                                    )}
                                </div>
                            </FormControl>
