...
export function UserTypeSelection({onSelect}: UserSelectionTypeProps){
    return(
        <div className="space-y-8">
            ...
            <Button  onClick={()=> onSelect('company')} variant='outline' className="w-full h-auto p-6 items-center gap-4 border-2 transition-all 
            duration-200 hover:border-primary hover:bg-primary/5">
            ...
            <Button  onClick={()=> onSelect('jobSeeker')} variant='outline' className="w-full h-auto p-6 items-center gap-4 border-2 transition-all 
            duration-200 hover:border-primary hover:bg-primary/5">
                <div className="size-12 rounded-full bg-primary/10 flex items-center justify-center">
